const LOCAL_FRAMES = [
  {
    ...
    frameUrl: new URL("assets/frames/HaNoiCycle.png", import.meta.url).href,
    thumbUrl: new URL("assets/frames/HaNoiCycle.png", import.meta.url).href,
    sortOrder: 1,
    isActive: true,
    source: "demo-local"
  },
  {
    ...
    frameUrl: new URL("assets/frames/demo-autumn-frame.png", import.meta.url).href,
    thumbUrl: new URL("assets/frames/demo-autumn-frame.png", import.meta.url).href,
    sortOrder: 2,
    isActive: true,
    source: "demo-local"
  }
...
export function getFrameSourceLabel(frame) {
  return frame.source === "demo-local" ? "Demo local" : "Cloudinary realtime";
}